...
public class TestExternalPortProcessor implements ExternalPortProcessor {
    ...
    static final String MODULE_NAME = "testexternalio"; //$NON-NLS-1$

    static final String INPUT_PROFILE_NAME = "input"; //$NON-NLS-1$

    static final String OUTPUT_PROFILE_NAME = "output"; //$NON-NLS-1$

    static final Phase PHASE_INPUT = Phase.IMPORT;

    static final Phase PHASE_OUTPUT = Phase.EXPORT;
    ...
    private List<CommandToken> toArguments(ExternalPortReference reference) {
